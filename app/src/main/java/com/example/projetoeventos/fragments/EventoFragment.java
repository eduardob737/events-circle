...
public class EventoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnConfirmarPresenca.setOnClickListener(view1 -> {
            viewModel.set_confirmacaoPresenca(true);
            verificaConfirmacao();
    ...
    private void verificaConfirmacao(){
        if (Objects.equals(viewModel.getConfirmacaoPresenca().getValue(), true)){
            binding.btnConfirmarPresenca.setVisibility(View.INVISIBLE);
            binding.btnCancelarPresenca.setVisibility(View.VISIBLE);
        }
    }
