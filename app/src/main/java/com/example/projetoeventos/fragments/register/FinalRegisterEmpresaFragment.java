...
import com.example.projetoeventos.databinding.FragmentFinalRegisterEmpresaBinding;
import com.example.projetoeventos.model.viewmodel.ViewModelRegisterEmpresa;


public class FinalRegisterEmpresaFragment extends Fragment {

    private FragmentFinalRegisterEmpresaBinding binding = null;
    private ViewModelRegisterEmpresa sharedViewModel = null;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentFinalRegisterEmpresaBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnVoltar.setOnClickListener(view2 ->{
            NavHostFragment.findNavController(FinalRegisterEmpresaFragment.this).navigate(R.id.action_finalRegisterEmpresaFragment_to_pessoaJuridicaFragment);
        });
    }
}